...
import com.garageservice.app.call.CallAdapter;
import com.garageservice.app.call.CallModel;
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (requestCode == PERMISSIONS_REQUEST_READ_CALLS) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(acContext, "Until you grant the permission, we canot display the Call Logs", Toast.LENGTH_SHORT).show();
            }
        }
