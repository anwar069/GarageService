...
import com.garageservice.app.search.SearchAdapter;
                    ...
                    if(isValidMobile(this.searchQuery)){
                        ...
                        for (int i = 0; i < jArray.length(); i++) {
                            ...
                            try {
                                ...
                                searchResult.setEmail(json_data.getString("Email"));
                                searchResult.setMobile(json_data.getString("Mobile"));
                                searchResult.setPicUrl(json_data.getString("PictureUrl"));
                                searchResult.setAddress(json_data.isNull("Address")?"": json_data.getString("Address"));
                                data.add(searchResult);
                            }catch (Exception e){
                                continue;
                            }
